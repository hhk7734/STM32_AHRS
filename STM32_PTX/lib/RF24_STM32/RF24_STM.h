...
#ifndef __RF24_STM_H__
#define __RF24_STM_H__

#include "RF24_STM_config.h"

extern SPIClass _SPI2; // using _SPI2 instead of SPI
...
public:
   ...
   * interrupts.
   *
   * @param[out] tx_ok The send was successful (NRF_TX_DS)
   * @param[out] tx_fail The send failed, too many retries (NRF_MAX_RT)
